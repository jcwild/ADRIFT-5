...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div style="height:100%" onclick="_FocusInput()">
        ...
        <div style="position:absolute;right:0px;top:3px;width:24px;height:24px"><asp:HyperLink ID="LinkDefault" ImageUrl="https://play.adrift.co/img/Back.png" NavigateUrl="~/Default.aspx" runat="server" /></div>
