Public Class clsObject
    ...
    Public Function DisplayObjectChildren() As String
        ...
        If sReturn = "" Then sReturn = "Nothing is on or inside " & FullName(True) & "."
        Return sReturn
    ...
    Friend ReadOnly Property Children(ByVal WhereChildren As WhereChildrenEnum, Optional ByVal bRecursive As Boolean = False) As ObjectHashTable
        Get
            ...
            For Each ob As clsObject In Adventure.htblObjects.Values
                If (WhereChildren <> WhereChildrenEnum.OnObject AndAlso ob.Location.DynamicExistWhere = clsObjectLocation.DynamicExistsWhereEnum.InObject) OrElse (WhereChildren <> WhereChildrenEnum.InsideObject AndAlso ob.Location.DynamicExistWhere = clsObjectLocation.DynamicExistsWhereEnum.OnObject) Then
...
Public Class clsObjectLocation
    ...
    Public Enum DynamicExistsWhereEnum
        ...
        WornByCharacter
    End Enum
    Public DynamicExistWhere As DynamicExistsWhereEnum
    ...
    Public Enum StaticExistsWhereEnum
        ...
        PartOfObject
    End Enum
    Public StaticExistWhere As StaticExistsWhereEnum
    ...
    Public Property Key() As String
        Get
            If sKey = "%Player%" AndAlso Adventure.Player IsNot Nothing Then sKey = Adventure.Player.Key
            Return sKey
        End Get
        Set(ByVal Value As String)
            sKey = Value
