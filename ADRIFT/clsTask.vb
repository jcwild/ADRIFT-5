Public Class clsTask
    ...
    Private _ContinueToExecuteLowerPriority As Boolean ' Multiple Matching
    Public Property bContinueToExecuteLowerPriority As Boolean
        Get
    ...
    Private oCompletionMessage As Description
    ...
    Public Enum BeforeAfterEnum
        ...
        After
    End Enum
    Public eDisplayCompletion As BeforeAfterEnum
...
#End If
    ...
    Private sLocationTrigger As String = ""
    ...
    Public Function TaskCommand(ByVal task As clsTask, Optional ByVal bReplaceSpecifics As Boolean = True) As String
                        ...
                        Case RestrictionTypeEnum.Character
                            ...
                            Select Case eCharacter
                                ...
                                Case CharacterEnum.BeInSameLocationAsObject
                                    If Adventure.GetTypeFromKeyNice(sKey2) = "Object" Then
                                        sSummary &= "be in the same location as " & Adventure.GetNameFromKey(sKey2)
                                    Else
                        ...
                        Case RestrictionTypeEnum.Property
                            ...
                            Select Case eMust
                                ...
                                Case MustEnum.MustNot
                                    sSummary &= " must not be "
                            End Select
                            Select Case Adventure.htblAllProperties(sKey1).Type
