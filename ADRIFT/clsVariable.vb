...
#Region "Expressions"
    ...
    Private Function PrintToken(ByVal iToken As Integer) As Integer
...
#End If
                                .Token = "expr"
                            Case "min", "max", "if", "rand", "either", "abs", "upr", "lwr", "ppr", "rgt", "lft", "mid", "ist", "len", "val", "str"
                                .Value = .Token
                                .Token = "funct"
                ...
                If currtoken.Right <> -1 Then
                    ...
                    If Token(currtoken.Right).Right <> -1 Then
                        ...
                        If Token(Token(currtoken.Right).Right).Right <> -1 Then
                            ...
                            If functoken.Token = "funct" And lptoken.Token = "lp" And _
                        ...
                        If lefttoken.Token = "expr" And optoken.Value = "AND" And righttoken.Token = "expr" And run = 2 Then
                            addtoken("expr", lefttoken.Value & righttoken.Value, lefttoken.Left, righttoken.Right)
                            If lefttoken.Left <> -1 Then Token(lefttoken.Left).Right = iToken - 1
                            If righttoken.Right <> -1 Then Token(righttoken.Right).Left = iToken - 1
                            changed = True
